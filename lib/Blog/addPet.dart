...
class _AddPetState extends State<AddPet> {
  ...
  List<S2Choice<String>> pet_racechoices = [
    ...
    S2Choice<String>(value: 'people', title: 'People'),
    S2Choice<String>(value: 'pets', title: 'Pets'),
    S2Choice<String>(value: 'car', title: 'Car'),
  ];
  List<S2Choice<String>> pet_sexchoices = [
    S2Choice<String>(value: 'free', title: 'Free items'),
    S2Choice<String>(value: 'negotiable', title: 'Negotiable items'),
  ];

  List<S2Choice<String>> pet_statuschoices = [
    S2Choice<String>(value: 'lost', title: 'Lost items'),
    S2Choice<String>(value: 'found', title: 'Found items'),
  ];
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          labelText: "descrpition for your post ",
        ),
        maxLength: 100,
        maxLines: 3,
      ),
