...
class _HomePageState extends State<HomePage> {
  ...
  List<String> titleString = ["Find my lost", "Profile Page"];
      ...
      drawer: Drawer(
        child: ListView(
          children: <Widget>[
            ...
            ListTile(
              title: Text("Add Lost Item ",style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            ListTile(
              title: Text("Latest Posts", style: TextStyle(fontWeight: FontWeight.bold)),
